...
def get_sat_img (lat, long):
    ...
    out = open('C:/Users/klinga/GlacierProject/sat_api/MODIS_Terra_CorrectedReflectance_TrueColor.png', 'wb')
    out.write(img.read())
    out.close()

    # displaying the image 
    Image('C:/Users/klinga/GlacierProject/sat_api/MODIS_Terra_CorrectedReflectance_TrueColor.png')
