# for calling satellite image API
...
# function for retreiving satellite API image in R
get_satellite_img <-function(name){
  # retrieve latitude and longitude of this glacier
  ctr <- 1
...
# function call 
get_satellite_img("Whiskey Glacier")


# displaying the image 
img <- magick::image_read('C:/Users/klinga/GlacierProject/sat_api/MODIS_Terra_CorrectedReflectance_TrueColor.png')
plot(img)
